"""Freeze the outcome-blind V1.2.1 support execution plan after V1.2 serialization abort."""
...
PLAN_OUT = OUT / "V1_2_1_SUPPORT_EXECUTION_PLAN_V1.json"
...
V12_SUPPORT_RUNNER = OUT / "run_support_diagnostics_v1_2_1.py"
SEMANTIC_MODULES = (
...
V12_ABORT_SHA256 = "ea97968682054f1b507efe8335e065bf7390881c66e51047351e09d123e2c90f"
V12_PLAN = OUT / "V1_2_SUPPORT_EXECUTION_PLAN_V1.json"
V12_PLAN_SHA256 = "39d7a0fa46bda14e742b86de1f703f74b711017158f6164b1fcc83849eccdc0d"
...
def build_plan(authorized_head: str) -> dict:
    ...
    frozen = {FOLDS: FOLD_SHA256, REGISTRY: REGISTRY_SHA256, RESPONSES: RESPONSES_SHA256,
              ...
              V12_ABORT: V12_ABORT_SHA256, V12_PLAN: V12_PLAN_SHA256}
    ...
    return {
        "artifact_version": "target_aware_v1_2_1_support_execution_plan_v1",
        "parent_v1_2_abort_sha256": V12_ABORT_SHA256,
        "parent_v1_2_support_plan_sha256": V12_PLAN_SHA256,
        "repair_scope": "serialization-only: normalize numpy.bool_ finite checks to builtin bool; no scientific semantics changed",
        ...
        "next_gate": "RUN_AND_FREEZE_OUTCOME_BLIND_V1_2_1_SUPPORT_AND_EVALUABILITY_DECISION",
    }
...
def main() -> None:
    ...
    print(json.dumps({
        "status": "V1_2_1_SUPPORT_EXECUTION_PLAN_FROZEN",

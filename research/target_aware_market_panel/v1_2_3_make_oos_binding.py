"""Freeze the V1.2.3 predictive OOS execution binding before label access."""
...
EXPECTED={
 ...
 ABORT:"1c0183478076babe5edb96ace29330a57d82de980bbf3810aa23876b033a3396",
...
def main():
    ...
    srcs=[
      ...
      ROOT/"research/target_aware_market_panel/run_predictive_oos_v1_2_3.py",
    ]
    doc={
      "artifact_version":"target_aware_v1_2_3_predictive_oos_binding_v1",
    ...
    print(json.dumps({"status":"V1_2_3_PREDICTIVE_BINDING_FROZEN","sha256":fsha(BINDING),
